...
(function() {
  ...
  YoutubeCollection = (function(_super) {
    ...
    YoutubeCollection.prototype.parse = function(response_) {
      var isPortrait, itemDate, itemDesc, itemEntry, itemId, itemModel, itemTags, itemUrl, modelsArray, _i, _len, _ref;
      modelsArray = [];
      _ref = response_['feed']['entry'];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        itemEntry = _ref[_i];
        ...
        isPortrait = false;
        if (this.isPortrait(itemTags) || this.isPortrait(itemDesc)) {
          isPortrait = true;
        }
    ...
    YoutubeCollection.prototype.isPortrait = function(string_) {
      if (string_) {
